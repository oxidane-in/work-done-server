...
public interface WorkOrderMaterialDetailsController {
    ...
    @PostMapping
    ResponseEntity<WorkOrderMaterialDetailsResponse> create(@RequestBody WorkOrderMaterialDetailsRequest request)
    ...
    ResponseEntity<WorkOrderMaterialDetailsResponse> update(
            ...
            @RequestBody WorkOrderMaterialDetailsRequest request)
            throws JsonProcessingException, SchemaValidationException;
