...
public class UnitOfMeasurementServiceImpl implements UnitOfMeasurementService {
    ...
    public UnitOfMeasurementResponse getUnitOfMeasurementById(Integer id) {
        try (MDC.MDCCloseable _ = MDC.putCloseable("requestId", UUID.randomUUID().toString())) {
    ...
    @Override
    @Transactional
    public UnitOfMeasurementResponse updateUnitOfMeasurement(Integer id, UnitOfMeasurementRequest request) {
        try (MDC.MDCCloseable _ = MDC.putCloseable("requestId", UUID.randomUUID().toString())) {
    ...
    @Override
    @Transactional
    public void deleteUnitOfMeasurement(Integer id) {
        try (MDC.MDCCloseable _ = MDC.putCloseable("requestId", UUID.randomUUID().toString())) {
